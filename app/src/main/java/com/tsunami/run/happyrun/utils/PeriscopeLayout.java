...
//    }
    ...
    private void init() {
        ...
        Drawable red = ResourcesCompat.getDrawable(getResources(), R.drawable.pl_red, null);
        Drawable yellow = ResourcesCompat.getDrawable(getResources(), R.drawable.pl_yellow, null);
        Drawable blue = ResourcesCompat.getDrawable(getResources(), R.drawable.pl_blue, null);
